	...
	<tr>
		...
		<?php endforeach; ?>
			...
			<div class="litespeed-desc">
				...
				<?php echo sprintf( __( 'Serve all image files through the CDN. This will affect all attachments, HTML %1$s tags, and CSS %2$s attributes.', 'litespeed-cache' ), '<code>&lt;img</code>', '<code>url()</code>' ); ?>
				...
				<?php echo sprintf( __( 'This will affect all tags containing attributes: %1$s %2$s %3$s.', 'litespeed-cache' ), '<code>src=""</code>', '<code>data-src=""</code>', '<code>href=""</code>' ); ?>
