...
<?php require_once LSCWP_DIR . 'admin/tpl/inc/check_cache_disabled.php'; ?>
	...
	<form method="post" action="admin.php?page=lscache-dash">
		...
		<div class="litespeed-row">
			...
			<div class="litespeed-cache-purgeby-text">
				<div class="
				<?php
				if ( $purgeby_option != LiteSpeed_Cache_Admin_Display::PURGEBY_CAT ) {
					echo 'litespeed-hide';}
				?>
				"
				...
				<div class="
				<?php
				if ( $purgeby_option != LiteSpeed_Cache_Admin_Display::PURGEBY_PID ) {
					echo 'litespeed-hide';}
				?>
				"
				...
				<div class="
				<?php
				if ( $purgeby_option != LiteSpeed_Cache_Admin_Display::PURGEBY_TAG ) {
					echo 'litespeed-hide';}
				?>
				"
				...
				<div class="
				<?php
				if ( $purgeby_option != LiteSpeed_Cache_Admin_Display::PURGEBY_URL ) {
					echo 'litespeed-hide';}
				?>
				"
					...
					<?php
					echo sprintf(
						__( 'e.g. Use %1$s or %2$s.', 'litespeed-cache' ),
