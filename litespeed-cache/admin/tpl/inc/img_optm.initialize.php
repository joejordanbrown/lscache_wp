...
?>
	...
	<div class="litespeed-width-7-10">
		...
		<div>
			...
			<?php require_once LSCWP_DIR . 'admin/tpl/inc/img_optm.communicate_notify.php'; ?>

			<?php require_once LSCWP_DIR . 'admin/tpl/inc/api_key.php'; ?>
	...
	<div class="litespeed-width-3-10 litespeed-column-java">
		<?php require_once LSCWP_DIR . 'admin/tpl/inc/img_optm.percentage_summary.php'; ?>
	</div>
