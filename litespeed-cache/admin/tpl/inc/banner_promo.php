...
<div class="litespeed-wrap notice notice-info litespeed-banner-promo-full">
		...
		<div class="litespeed-row-flex litespeed-flex-wrap litespeed-margin-y5">
			...
			<div>
				<p class="litespeed-text-small">
					...
					<?php
					echo sprintf(
						__( '<a %1$s>Support forum</a> | <a %2$s>Submit a ticket</a>', 'litespeed-cache' ),
	...
	<div>
		<?php
		$dismiss_url = LiteSpeed_Cache_Utility::build_url(
			LiteSpeed_Cache::ACTION_DISMISS,
			LiteSpeed_Cache_GUI::TYPE_DISMISS_PROMO,
			false,
			null,
			array(
				'promo_tag' => 'banner_promo',
				'later'     => 1,
			)
		);
		?>
